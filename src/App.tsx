...
// Display labels & tooltips are now i18n keys (resolved via t() at render).
...
function LangToggle() {
  ...
  return (
    <button
      key={lang}
      onClick={() => toggleLang()}
      className="theme-toggle fixed top-5 right-[4.25rem] z-50 h-10 px-3 min-w-10 rounded-full flex items-center justify-center bg-white/80 dark:bg-warm-850/80 border border-warm-200 dark:border-warm-700/40 shadow-warm-sm dark:shadow-warm-md backdrop-blur-sm focus-warm text-sm font-medium text-warm-700 dark:text-warm-300"
